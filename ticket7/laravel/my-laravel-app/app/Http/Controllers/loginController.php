...
class loginController extends Controller
{
    ...
    public function handelLogin(Request $request){
       ...
       if(!Auth::attempt($user)){
        return response()->json([
            'status' => 'error',
            'error_message' => 'Invalid credentials',401
        ]);
       }
       # Genrate token 
       $userdata = Auth::user();
...
#Topics Covered: Understanding the auth functionality and implement explore about the token and how can we gentate it 